...
namespace CrmAtlas.Infrastructure.Data.Migrations
{
    ...
    public partial class UseUtcTimestamps : Migration
    {
        ...
        {
            // Existing timestamp values represent UTC. Fix the session timezone so
            // PostgreSQL preserves the instant while converting to timestamptz.
            migrationBuilder.Sql("SET LOCAL TIME ZONE 'UTC';");
            ...
            migrationBuilder.AlterColumn<DateTime>(
                name: "ultima_mudanca_situacao_em",
                table: "acompanhamento_servicos",
                type: "timestamp with time zone",
                nullable: true,
                oldClrType: typeof(DateTime),
