...
builder.Services.AddScoped<ISavedViewsService, SavedViewsService>();
    ...
    try
    {
        ...
        if (dbContext.Database.IsRelational())
        {
            dbContext.Database.ExecuteSqlRaw(@"
                ...
                ALTER TABLE cadastro_servicos ADD COLUMN IF NOT EXISTS valor_nota_fiscal_dividido boolean NOT NULL DEFAULT true;
                ALTER TABLE cadastro_servicos ADD COLUMN IF NOT EXISTS valor_nota_fiscal_parcela integer;
                ...
                ALTER TABLE condicoes_pagamento ADD COLUMN IF NOT EXISTS entrada boolean NOT NULL DEFAULT false;
                ...
                ALTER TABLE orcamentos ADD COLUMN IF NOT EXISTS convertido_em timestamp with time zone;

                CREATE TABLE IF NOT EXISTS cadastro_servico_codigo_historico (
                    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    servico_id bigint NOT NULL REFERENCES cadastro_servicos(id) ON DELETE CASCADE,
                ...
                CREATE TABLE IF NOT EXISTS servico_tipo_campo_config (
                    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                    tipo_servico character varying(32) NOT NULL,
                    campo character varying(32) NOT NULL,
                    visivel boolean NOT NULL DEFAULT true,
                    obrigatorio boolean NOT NULL DEFAULT false,
                    CONSTRAINT uq_servico_tipo_campo UNIQUE (tipo_servico, campo)
                );
                ...
                CREATE UNIQUE INDEX IF NOT EXISTS uq_servico_tipo_config_tipo ON servico_tipo_config (tipo_servico);
