        ...
        => ExecuteAsync(async () =>
        {
            ...
            foreach (var row in rows)
            {
                ...
                var item = new AcompanhamentoServico
                {
                    ...
                    CondicaoPagamento = row.CondicaoPagamento?.Trim(),
                    AReceber = row.AReceber,
                    Recebido = row.Recebido,
                    Custos = row.Custos,
                    ProximaParcela = row.ProximaParcela,
